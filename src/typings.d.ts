...
declare module 'virtual-lcap:lcap-ui' {
  ...
  export const UNavbar: any;
  export const UNavbarItem: any;
  export const UNavbarDivider: any;
  export const UNavbarDropdown: any;
  export const UNavbarMenu: any;
  export const UNavbarMenuGroup: any;
  export const UNavbarMenuItem: any;
  export const UNavbarMenuDivider: any;
  export const UNavbarSelect: any;
  export const UNavbarSelectGroup: any;
  export const UNavbarSelectItem: any;
  export const UNavbarSelectDivider: any;
