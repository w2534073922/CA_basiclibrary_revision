...
namespace extensions.vue_library_example.viewComponents {
  ...
  @ExtensionComponent({
    replaceNaslUIComponent: "UCapsules",
    type: "pc",
    show: true,
    ideusage: {
      "idetype": "container",
      "structured": true,
      "childAccept": "['ex-u-capsule', 'ex-u-capsules-group'].includes(target.tag)"
    }
  })
  @Component({
    title: '胶囊',
  ...
  export class ExUCapsules<M extends nasl.core.Boolean> extends ViewComponent {
    @Prop({
      title: "值"
    })
    value: ExUCapsulesOptions<M>['value'];
    @Prop({
      title: '禁用'
    })
    ...
    constructor(options?: Partial<ExUCapsulesOptions<M>>) {
      super();
    }
  }
  export class ExUCapsulesOptions<M extends nasl.core.Boolean> extends ViewComponentOptions {
    @Prop({
      group: '数据属性',
      title: '选中值',
      description: '当前选中的值',
    ...
    @Slot({
      title: 'undefined',
      description: '插入`<ex-u-capsule>`或`<ex-u-capsules-group>`子组件。',
      snippets: [{
        title: '胶囊选项',
        code: '<ex-u-capsule>选项</ex-u-capsule>'
      }]
    })
  ...
  @ExtensionComponent({
    ...
    ideusage: {
      "idetype": "container",
      "parentAccept": "['ex-u-capsules', 'ex-u-capsules-group'].includes(target.tag)"
    }
  })
  @Component({
    title: '子选项',
  ...
  export class ExUCapsule extends ViewComponent {
    @Prop({
      title: '禁用'
    })
    disabled: nasl.core.Boolean;
    constructor(options?: Partial<ExUCapsuleOptions>) {
      super();
    }
  }
  export class ExUCapsuleOptions extends ViewComponentOptions {
    @Prop({
      title: '相关对象',
  ...
  @ExtensionComponent({
    ...
    ideusage: {
      "idetype": "container",
      "structured": true,
      "parentAccept": "target.tag === 'ex-u-capsules'",
      "childAccept": "target.tag === 'ex-u-capsule'"
    }
  })
  @Component({
    title: '子选项组',
  ...
  export class ExUCapsulesGroup extends ViewComponent {
    constructor(options?: Partial<ExUCapsulesGroupOptions>) {
      super();
    }
  }
  export class ExUCapsulesGroupOptions extends ViewComponentOptions {
    @Slot({
      title: 'undefined',
      description: '插入`<ex-u-capsule>`或`<ex-u-capsules-group>`子组件。',
      snippets: [{
